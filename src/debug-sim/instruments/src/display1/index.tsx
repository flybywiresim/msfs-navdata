...
export const DebugDisplay1 = () => {
    ...
    return(
        <div style={{ backgroundColor: "white" }}>
            ...
            <h2>To: {flightPlan.destinationAirport?.ident}, Transition: {flightPlan.procedureDetails.arrivalTransitionIdentifier}, Arrival: {flightPlan.procedureDetails.arrivalIdentifier}</h2>
            <input onChange={(e) => {
                if(e.target.value.length === 4)
